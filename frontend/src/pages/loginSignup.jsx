...
const LoginSignup = () => {
  ...
  const [state,setState] = useState("Login");//change state b/w login ,signup
      ...
      <div className="loginsignup-container">
        ...
        <div className="loginsignup-fields">
         {state === "Sign Up"?<input name='username' value={formData.username} onChange={ChangeHandeler} type="text"  placeholder='Your Name'/>:<></>} 
          <input name="email" value={formData.email} onChange={ChangeHandeler} type="email" placeholder='Email' />
